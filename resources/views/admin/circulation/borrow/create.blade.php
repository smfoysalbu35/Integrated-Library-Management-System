...
@section('content-header')
    @if(auth()->guard()->user()->user_type === 1)
        <a href="{{ route('borrows.index') }}" class="btn btn-primary"><i class="fa fa-reply-all"></i> Back</a>
        <ol class="breadcrumb">
            <li><p><i class="fa fa-refresh"></i> Circulation</p></li>
            <li class="active"><a href="{{ route('borrows.index') }}">Borrow</a></li>
            <li class="active"><a href="{{ route('borrows.create') }}">Borrow Book</a></li>
        </ol>
    @else
        <h1>Manage Borrow</h1>
        <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Borrow Book</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button type="button" name="btnBorrow" id="btnBorrow" class="btn btn-default">Borrow</button>
                                        </div>
                                    </div>
