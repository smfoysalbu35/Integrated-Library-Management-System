...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ route('patrons.edit', ['patron' => $patron->id]) }}">Edit Patron</a></li>
    </ol>
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Patron</h3>
                </div>
                <!-- box-header -->

                <form action="{{ route('patrons.update', ['patron' => $patron->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <!-- box-body -->
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="patron_no" id="patron_no" value="{{ $patron->patron_no }}" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="middle_name" id="middle_name" value="{{ $patron->middle_name }}" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="house_no" id="house_no" value="{{ $patron->house_no }}" class="form-control">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="street" id="street" value="{{ $patron->street }}" class="form-control">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="barangay" id="barangay" value="{{ $patron->barangay }}" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="municipality" id="municipality" value="{{ $patron->municipality }}" class="form-control">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="province" id="province" value="{{ $patron->province }}" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_no" id="contact_no" value="{{ $patron->contact_no }}" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="patron_type_id" id="patron_type_id" class="form-control select2" style="width: 100%;">
                                        @foreach($patronTypes as $patronType)
                                            @if($patronType->id == $patron->patron_type->id)
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="section_id" id="section_id" class="form-control select2" style="width: 100%;">
                                        @foreach($sections as $section)
                                            @if($section->id == $patron->section->id)
