...
@section('title', 'Paid Penalty Report')

@section('content-header')
    <h1>Paid Penalty</h1>
    <ol class="breadcrumb">
        <li><p><i class="fa fa-bar-chart"></i> Reports</p></li>
        <li class="active"><a href="{{ route('report.paid-penalties.index') }}">Paid Penalty Report</a></li>
    </ol>
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Paid Penalty Report</h3>
                </div>
                <!-- box-header -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="paidPenaltiesTable" class="table table-bordered table-striped table-hover text-center">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="paidPenaltiesTableBody">
    ...
    <script>
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success : (response) => {
                        if(response.data.length > 0) {
                            ...
                            $('#paidPenaltiesTableBody').html(paidPenaltiesTable)
                        }else {
                            $('#btnPrint').addClass('invisible')
                            $('#paidPenaltiesTableBody').html('<tr><td colspan="9"><h5>No Paid Penalty Report Found</h5></td></tr>')
                        }
                    },
                    error : (error) => {
                        $('#btnPrint').addClass('invisible')
            ...
            $('#btnPrint').click(function() {
                let from = $('#from').val()
                let to = $('#to').val()
                window.open(`/report/paid-penalties/print?from=${from}&to=${to}`)
            });
        });
        ...
        function clear() {
            $('.text-danger').html('')
            $('#paidPenaltiesTableBody').html('<tr><td colspan="9"><h5></h5></td></tr>')
        }
    </script>
@endpush
